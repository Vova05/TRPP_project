...
float mathematic::calculating1(char* OPZSTR, int len,int index)
{
    string answer;
    float stack[100];
    //bool chek_abs=false;
...
float mathematic::resolt_math(char* arr,int index)
{
...
//                break;
   ...
   // for (int index=0;index<3;index++) {
       //return mathematic::calculating1(exit, i,index); // calculating // считаем
    return 2;
    //}
}
